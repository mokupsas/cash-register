...
/**
 * Manages purchase within cash drawer
 * @param price		Price for payment being made.
 * @param cash		Cash given by payer.
 * @param cid		2D array with cash-in-drawer.
 * @return json 	JSON with status code and change (i.e. {status: "", change: []})
 */
function checkCashRegister(price, cash, cid) {
	...
	totalCash = totalInDrawer(cid);	// total cash in drawer
...
/**
 * Add currency unit and its change value to array
 * @param unit 		Currency unit name (i.e. "PENNY", "DIME").
 * @param change 	Change value for current currency unit.
 * @return array 	Array with change values.
 */		
